function x = CSL1NlCg_CompositeL1_DCE(x0,param,param2,param3,param4,param5,param6) % CompositeL1, TGV
%
% res = CSL1NlCg(param)
%
...
% compute g0  = grad(f(x))
g0 = grad(x,param,param2,param3,param4,param5,param6); % CompositeL1, DCE
dx = -g0;
...
while(1)
    ...
    %conjugate gradient calculation
    g1 = grad(x,param,param2,param3,param4,param5,param6); % CompositeL1, DCE
    bk = g1(:)'*g1(:)/(g0(:)'*g0(:)+eps);
    g0 = g1;
    dx =  - g1 + bk* dx;
    k = k + 1;
