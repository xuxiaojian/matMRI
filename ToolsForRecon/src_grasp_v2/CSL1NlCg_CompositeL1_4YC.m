function x = CSL1NlCg_CompositeL1_4YC(x0,param,param2) % CompositeL1
%
% res = CSL1NlCg(param)
%
...
% compute g0  = grad(f(x))
g0 = grad(x,param,param2); % CompositeL1
dx = -g0;
...
% objective function
res=L2Obj+param.lambda*L1Obj+param2.lambda*L1Obj2; % CompositeL1
...
function g = grad(x,param,param2)%*********************************************** % CompositeL1
